...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE GENERATOR, CSE DEPARTMENT, CU</h3>
        </div>
    </div>
</div>
...
<div align="center">
    <form data-scroll-reveal="enter from the bottom after 0.2s" action="studentvalidation.php" method="post">
        <select id="select_semester" name="select_semester" class="list-group-item">
            ...
            <option value="3"> BE II Year ( Semester III )</option>
            <option value="4"> BE II Year ( Semester IV )</option>
            <option value="5"> BE III Year ( Semester V )</option>
            <option value="6"> BE III Year ( Semester VI )</option>
            <option value="7"> BE IV Year ( Semester VII )</option>
            <option value="8"> BE IV Year ( Semester VIII )</option>
        </select>
    ...
    <div class="container set-pad">
        <div class="row text-center">
            <div class="col-lg-8 col-lg-offset-2 col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
                <h1 data-scroll-reveal="enter from the bottom after 0.1s" class="header-line">LEADERSHIP OF CU </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. R. S. Bawa</h3>
                    <hr/>
                    <h4 align="center">Vice Chancellor<br/>CU</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Satnam Singh Sandhu</h3>
                    <hr/>
                    <h4 align="center">Chancellor<br/> CU</h4>
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    ...
                    <h3 align="center">Dr. B. S. Sohi</h3>
                    <hr/>
                    <h4 align="center">Pro-Vice Chancellor<br/>CU</h4>
...
<div class="container">
    <div class="row set-row-pad">
        <div class="col-lg-4 col-md-4 col-sm-4   col-lg-offset-1 col-md-offset-1 col-sm-offset-1 "
            ...
            <hr/>
            <div>
                <h4>Chandigarh-Ludhiana Highway,
					Gharuan, Mohali(Punjab)
                </h4>
                <h4>India - 140413</h4>
                <h4><strong>Call:</strong> 1603051003 </h4>
                <h4><strong>Email: </strong>info@cumail.in</h4>
            </div>
